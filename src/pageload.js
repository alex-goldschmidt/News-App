export const PageLoad = (() => {
  ...
  <figure class="category">
      <img class="image" src="..src/images/Russia Ukraine.png" alt="m1">
  ...
  <figure class="category">
      <img class="image" src="..src/images/Big tech.png" alt="m1">
  ...
  <figure class="category">
      <img class="image" src="..src/images/Economy.png" alt="m1">
  ...
  <figure class="category">
      <img class="image" src="..src/images/Congress.png" alt="m1">
  ...
  <figure class="category">
      <img class="image" src="../src/images/China.png" alt="m1">
